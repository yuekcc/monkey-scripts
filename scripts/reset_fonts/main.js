const colorEmojiFont = 'Noto Color Emoji'
const emojiFont = 'Noto Emoji'
const genericFont = 'HarmonyOS Sans SC'
const genericFallbackFont = '更纱黑体 UI SC'
const codeFont = 'Maple Mono Normal'
...
:root {
  --generic-font-family: ${JSON.stringify(genericFont)}, ${JSON.stringify(genericFallbackFont)}, system-ui;
  --code-font-family: ${JSON.stringify(codeFont)}, monospace;
}
